...
public class ItemReportsController {
    ...
    @PostMapping
    public ResponseEntity<ItemReports> createItemReport(@RequestBody ItemReports itemReports) {
        ItemReports createdItemReport = itemReportsService.saveItemReport(itemReports);
